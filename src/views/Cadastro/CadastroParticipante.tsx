...
import { BasicDataStep } from "../../components/register-steps/Participante/BasicDataStep";
import { FavoriteDataStep } from "../../components/register-steps/Participante/FavoriteDataStep";
import { FinalStep } from "../../components/register-steps/Participante/FinalStep";
import { LocationDataStep } from "../../components/register-steps/Participante/LocationDataStep";
import { ParticipantBasicStepFormData, LocationStepFormData } from "../../types/types";


export function CadastroParticipante() {

    const getBasicDataStep = (basicData: ParticipantBasicStepFormData) => {
    ...
    const [basicData, setBasicData] = useState<ParticipantBasicStepFormData>();
